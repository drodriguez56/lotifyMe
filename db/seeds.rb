Pick.create(number: '313556596306', game: 'powerball', draw_date: '01/20/15', user_id: 1)
Pick.create(number: '313577796306', game: 'powerball', draw_date: '01/16/15', user_id: 1)
Pick.create(number: '313556577706', game: 'powerball', draw_date: '01/13/15', user_id: 2)
Pick.create(number: '377756596306', game: 'powerball', draw_date: '01/20/15', user_id: 2)
Pick.create(number: '313557777306', game: 'powerball', draw_date: '01/09/15', user_id: 3)
Pick.create(number: '377777596306', game: 'powerball', draw_date: '01/20/15', user_id: 4)
